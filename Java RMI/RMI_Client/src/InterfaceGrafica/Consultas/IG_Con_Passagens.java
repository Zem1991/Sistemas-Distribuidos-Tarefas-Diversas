 ...
 */
public class IG_Con_Passagens extends javax.swing.JFrame {
    /**
     * Creates new form IG_CadastroSimples_teste
     */
    public IG_Con_Passagens() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new IG_Con_Passagens().setVisible(true);
        });
    }
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        try {
            ...
            table_elementos.setModel(
                    servente.consultarDB("select * from passagens")
            );
        } catch (RemoteException ex) {
            Logger.getLogger(IG_Con_Passagens.class.getName()).log(Level.SEVERE, null, ex);
        }
