...
public class IG_Op_Itens_VendasHospedagem extends javax.swing.JFrame {
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        try {
            ...
            table_elementos.setModel(
                    servente.consultarDB("select * from itensvendadehospedagem where id_venda = " + vendaAtual)
            );
        } catch (RemoteException ex) {
            Logger.getLogger(IG_Op_Itens_VendasHospedagem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        try {
            switch (modoDeDados){
                case DADOS_INSERIR:
                    Cliente.getServer().insertItemVendaDeHospedagem(Integer.parseInt(tf_idVenda.getText()),
