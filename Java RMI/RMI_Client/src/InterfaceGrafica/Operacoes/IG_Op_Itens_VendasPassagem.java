...
public class IG_Op_Itens_VendasPassagem extends javax.swing.JFrame {
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        try {
            ...
            table_elementos.setModel(
                    servente.consultarDB("select * from itensvendadepassagem where id_venda = " + vendaAtual)
            );
        } catch (RemoteException ex) {
            Logger.getLogger(IG_Op_Itens_VendasPassagem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        try {
            switch (modoDeDados){
                case DADOS_INSERIR:
                    Cliente.getServer().insertItemVendaDePassagem(Integer.parseInt(tf_idVenda.getText()),
