 ...
 */
public class IG_Cad_Locais extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        locaisQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager.createQuery("SELECT l FROM Locais l");
        locaisList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : locaisQuery.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, locaisList, table_elementos);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new IG_Cad_Locais().setVisible(true);
        });
    }
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        ResultSet rs = DatabaseOperations.consultarDB("select * from locais");
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        switch (modoDeDados){
            case DADOS_INSERIR:
                DatabaseOperations.insertLocal(tf_nome.getText());
                break;
            case DADOS_MODIFICAR:
                DatabaseOperations.updateLocal(Integer.parseInt(tf_id.getText()), tf_nome.getText());
                break;
            case DADOS_EXCLUIR:
    ...
    private java.util.List<Database.Locais> locaisList;
    private javax.persistence.Query locaisQuery;
