 ...
 */
public class IG_CadComp_QuartosHotel extends javax.swing.JFrame {
     ...
     */
    public IG_CadComp_QuartosHotel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        quartoshotelQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager.createQuery("SELECT q FROM Quartoshotel q");
        quartoshotelList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : quartoshotelQuery.getResultList();
        jPanel3 = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        tf_idPrincipal = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        tf_nomePrincipal = new javax.swing.JTextField();
        ...
        tf_idHotel = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        tf_nomeQuarto = new javax.swing.JTextField();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Hotel"));

        jLabel2.setText("ID");

        jLabel3.setText("Nome");

        tf_nomePrincipal.setEnabled(false);

        b_Filtrar.setText("Filtrar");
        b_Filtrar.setMaximumSize(new java.awt.Dimension(75, 23));
        b_Filtrar.setMinimumSize(new java.awt.Dimension(75, 23));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tf_nomePrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(b_Filtrar, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(jLabel3)
                .addComponent(tf_nomePrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(b_Filtrar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Todos os quartos"));
        jPanel1.setToolTipText("");

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, quartoshotelList, table_elementos);
        ...
        jLabel4.setText("ID do Hotel");

        tf_idHotel.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idHotel}"), tf_idHotel, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabel6.setText("Nome do Quarto");

        tf_nomeQuarto.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nome}"), tf_nomeQuarto, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tf_idHotel, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tf_nomeQuarto, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tf_idHotel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(tf_nomeQuarto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new IG_CadComp_QuartosHotel().setVisible(true);
        });
    }
    ...
    private void b_InserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_InserirActionPerformed
        ...
        tf_idHotel.setEnabled(true);
        tf_nomeQuarto.setEnabled(true);
        ...
        //tf_nomePrincipal.setEnabled(false);   //CAMPO DE PREENCHIMENTO AUTOMATICO!
        
        //Limpa os campos de edição dos componentes, para que novos valores sejam informados.
        tf_id.setText("");
        tf_idHotel.setText("");
        tf_nomeQuarto.setText("");
        tf_preco.setText("");
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        ResultSet rs;
        if (tf_idPrincipal.getText().isEmpty()){
            rs = DatabaseOperations.consultarDB("select * from quartoshotel");
        }else{
            rs = DatabaseOperations.consultarDB("select * from quartoshotel where id_hotel = "
                    + Integer.parseInt(tf_idPrincipal.getText()) + ";");
        }
    ...
    private void b_CancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_CancelarActionPerformed
        ...
        //Bloqueia os componentes relacionados ao principal cujo componente será cadastrado.
        tf_idPrincipal.setEnabled(true);
        //tf_nomePrincipal.setEnabled(true);   //CAMPO DE PREENCHIMENTO AUTOMATICO!
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        switch (modoDeDados){
            case DADOS_INSERIR:
                DatabaseOperations.insertQuartoHotel(Integer.parseInt(tf_idHotel.getText()), tf_nomeQuarto.getText(), Integer.parseInt(tf_preco.getText()));
                break;
            case DADOS_MODIFICAR:
                DatabaseOperations.updateQuartoHotel(Integer.parseInt(tf_id.getText()),
                        Integer.parseInt(tf_idHotel.getText()), tf_nomeQuarto.getText(), Integer.parseInt(tf_preco.getText()));
                break;
            case DADOS_EXCLUIR:
    ...
    private java.util.List<Database.Quartoshotel> quartoshotelList;
    private javax.persistence.Query quartoshotelQuery;
    private javax.swing.JTable table_elementos;
    private javax.swing.JTextField tf_id;
    private javax.swing.JTextField tf_idHotel;
    private javax.swing.JTextField tf_idPrincipal;
    private javax.swing.JTextField tf_nomePrincipal;
    private javax.swing.JTextField tf_nomeQuarto;
