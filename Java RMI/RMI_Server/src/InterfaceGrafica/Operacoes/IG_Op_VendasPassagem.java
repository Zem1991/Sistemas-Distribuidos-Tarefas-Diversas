 ...
 */
public class IG_Op_VendasPassagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        vendasdepassagemQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager.createQuery("SELECT v FROM Vendasdepassagem v");
        vendasdepassagemList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : vendasdepassagemQuery.getResultList();
        itensvendadepassagemQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager.createQuery("SELECT i FROM Itensvendadepassagem i");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Todas as vendas de passagem"));

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, vendasdepassagemList, table_elementos);
        ...
        jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, itensvendadepassagemList, table_itensDosElementos);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new IG_Op_VendasPassagem().setVisible(true);
        });
    }
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        ResultSet rs = DatabaseOperations.consultarDB("select * from vendasdepassagem");
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        switch (modoDeDados){
            case DADOS_INSERIR:
                ...
                DatabaseOperations.insertVendaDePassagem(tf_cliente.getText(), tf_cartao.getText(),
    ...
    private void b_EditarItensDaVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_EditarItensDaVendaActionPerformed
        if (tf_id.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Nenhuma venda de passagem foi selecionada.", 
                        "ERRO", JOptionPane.ERROR_MESSAGE);
        }else{
            IG_Op_Itens_VendasPassagem ig_Op_Itens_VendasPassagem = new IG_Op_Itens_VendasPassagem(
                    Integer.parseInt(tf_id.getText()), tf_cliente.getText()
            );
            ig_Op_Itens_VendasPassagem.setVisible(true);
        }
    ...
    private java.util.List<Database.Vendasdepassagem> vendasdepassagemList;
    private javax.persistence.Query vendasdepassagemQuery;
