 ...
 */
public class IG_Op_Itens_VendasHospedagem extends javax.swing.JFrame {
     ...
     */
    public IG_Op_Itens_VendasHospedagem() {
        initComponents();
    }
    public IG_Op_Itens_VendasHospedagem(int idVenda, String cliente){
        vendaAtual = idVenda;
        initComponents();
    ...
    private void initComponents() {
        ...
        itensvendadehospedagemQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager0.createQuery("SELECT * FROM Itensvendadehospedagem i WHERE id_venda = " + vendaAtual);
        ...
        tf_hospedes = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        ftf_dataDeEntrada = new javax.swing.JFormattedTextField();
        jLabel9 = new javax.swing.JLabel();
        ftf_dataDeSaida = new javax.swing.JFormattedTextField();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, itensvendadehospedagemList, table_elementos);
        ...
        jLabel6.setText("ID da Hospedagem");
        ...
        jLabel7.setText("Hospedes");

        tf_hospedes.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.hospedes}"), tf_hospedes, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabel8.setText("Data de entrada");

        ftf_dataDeEntrada.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.dataentrada}"), ftf_dataDeEntrada, org.jdesktop.beansbinding.BeanProperty.create("value"));
        bindingGroup.addBinding(binding);

        jLabel9.setText("Data de saída");

        ftf_dataDeSaida.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.datasaida}"), ftf_dataDeSaida, org.jdesktop.beansbinding.BeanProperty.create("value"));
        bindingGroup.addBinding(binding);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tf_hospedes, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ftf_dataDeEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ftf_dataDeSaida, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(tf_hospedes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(ftf_dataDeEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                    .addComponent(ftf_dataDeSaida, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new IG_Op_Itens_VendasHospedagem().setVisible(true);
        });
    }
    ...
    private void b_InserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_InserirActionPerformed
        ...
        tf_hospedes.setEnabled(true);
        ftf_dataDeEntrada.setEnabled(true);
        ftf_dataDeSaida.setEnabled(true);
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        ResultSet rs = DatabaseOperations.consultarDB("select * from itensvendadehospedagem where id_venda = " + vendaAtual);
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        switch (modoDeDados){
            case DADOS_INSERIR:
                DatabaseOperations.insertItemVendaDeHospedagem(Integer.parseInt(tf_idVenda.getText()),
                        Integer.parseInt(tf_idQuartoHotel.getText()), tf_hospedes.getText(), 
                        ftf_dataDeEntrada.getText(), ftf_dataDeSaida.getText());
                break;
    ...
    private javax.swing.JFormattedTextField ftf_dataDeEntrada;
    private javax.swing.JFormattedTextField ftf_dataDeSaida;
    ...
    private javax.swing.JTextField tf_hospedes;
