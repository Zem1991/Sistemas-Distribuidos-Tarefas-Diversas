...
public class IG_Op_PacotesTuristicos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pacotesturisticosQuery = java.beans.Beans.isDesignTime() ? null : DISTRIBUIDOSRMIPUEntityManager.createQuery("SELECT p FROM Pacotesturisticos p");
        pacotesturisticosList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : pacotesturisticosQuery.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, pacotesturisticosList, table_elementos);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table_elementos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.status}"), tf_status, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void b_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_AtualizarActionPerformed
        ResultSet rs = DatabaseOperations.consultarDB("select * from pacotesturisticos");
    ...
    private void b_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_OkActionPerformed
        switch (modoDeDados){
            case DADOS_INSERIR:
                DatabaseOperations.insertPacoteTuristico(tf_cliente.getText(), Integer.parseInt(tf_numeroPessoas.getText()),
    ...
    private java.util.List<Database.Pacotesturisticos> pacotesturisticosList;
    private javax.persistence.Query pacotesturisticosQuery;
